(function() {
    ...
    angular.module('chattapp', ['ionic', 'ngStorage', 'ngFileUpload', 'ngImgCrop', 'ngResource', 'GoogleLoginService', 'facebookLoginService', 'ngMessages', 'ngSanitize', 'emojiApp', 'ngCordova', 'uiGmapgoogle-maps'])
